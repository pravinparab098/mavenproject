...
public class frameWork4_HashMap extends BaseTest {
	...
	@Test(dependsOnMethods = { "submitOrder" }, dataProvider = "getData", retryAnalyzer=RetryListeners.class) // OrderHistoryTest run only when submitOrder is successfully run
	...
	public Object[][] getData() {
		...
		HashMap<String, String> zara = new HashMap<String, String>();
		zara.put("email", "anshika@gmail.com");
		zara.put("password", "Iamking@000");
		zara.put("productName", "ZARA COAT 3");

		HashMap<String, String> iphone = new HashMap<String, String>();
		iphone.put("email", "shetty@gmail.com");
		iphone.put("password", "Iamking@000");
		iphone.put("productName", "IPHONE 13 PRO");

		return new Object[][] { { zara }, { iphone } };
